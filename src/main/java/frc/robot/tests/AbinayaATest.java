...
public class AbinayaATest implements Test
{
     ...
     */
    public AbinayaATest(RobotContainer robotContainer)
    {
    ...
    public void init()
    {
        ...
        //controller.a().onFalse(agitator.stopCommand());

        controller.b().onTrue(agitator.reverseCommand());
