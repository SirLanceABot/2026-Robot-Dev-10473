 ...
 */
 public class Drivetrain extends TunerSwerveDrivetrain implements Subsystem 
 {
    ...
    /**
     * Makes the drivetrain wheels of the robot move
     * 
     * @param leftYAxis Forward/backward direction to move
     * @param leftXAxis Left/right direction to move
     * @param rightXAxis Direction and speed to rotate
     * @param scaleFactor What percentage of max speed to move
     * @return A command to drive the robot in a field centric manner
     * @author Mason Bellinger
     */

    public Command driveCommand(DoubleSupplier leftYAxis, DoubleSupplier leftXAxis, DoubleSupplier rightXAxis, DoubleSupplier scaleFactor)
    {
        return applyRequest(() -> drive
            .withVelocityX(leftYAxis.getAsDouble() * scaleFactor.getAsDouble())
            .withVelocityY(leftXAxis.getAsDouble() * scaleFactor.getAsDouble())
            .withRotationalRate(rightXAxis.getAsDouble() * scaleFactor.getAsDouble())
        );
    }

    /**
     * @return A command to lock the wheels
     * @author Mason Bellinger
     */
     ...
     * @param leftYAxis Forward/backward direction to move
     * @param leftXAxis Left/right direction to move
     * @return A command to point the drivetrain wheels in the desired direction
     */
